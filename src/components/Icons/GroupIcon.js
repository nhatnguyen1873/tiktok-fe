...
const GroupIcon = memo(({ width = "100%", height = "100%", ...props }) => (
    <svg
        width={width}
        data-e2e=""
        height={height}
...
const GroupSolidIcon = memo(({ width = "100%", height = "100%", ...props }) => (
    <svg
        width={width}
        data-e2e=""
        height={height}
...
GroupSolidIcon.propTypes = {
    width: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
    height: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};

export { GroupIcon, GroupSolidIcon };
